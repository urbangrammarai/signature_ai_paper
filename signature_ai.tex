...
\begin{abstract}
    ...
    While deep learning is established in the analysis of urban satellite imagery, its
    application has so far mostly ignored the geographical nature of the images.
    ...
    accuracy of a subset of the tested models is competitive with established land cover
    classification models, especially when applying geographically-explicit methods. This
    suggests that satellite
    imagery presents a promising source and reflect form and function of urban environment
    in greater detail than is usually present in available remote sensing products.
\end{abstract}
%
\vspace{1.5ex}
%
