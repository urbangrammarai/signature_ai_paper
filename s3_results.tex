...
Whilst plotting accuracy is a way to build an intuition about the performance of
...
weighted and Macro F1 average). We can draw a few conclusions from this. First, chip size
seems to be o positive effect on the results, as it is consistently
...
what we have seen in figure \ref{fig:wc_accuracy_x_model}. We can see that
...
options, the inclusion of spatial lag in the modelling step has a significant effect (at
