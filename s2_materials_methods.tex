...
% 500 words
The goal of our experiments is to compare different models under different
...
use a set of performance scores that operate at the global and class level,
...
We use four standard performance scores. The kappa statistic ($\kappa$) XXX.
