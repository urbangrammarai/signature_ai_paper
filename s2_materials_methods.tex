...
applicable to spatial signatures. Zooming would change the scale of the urban environment
we attempt to capture, while the distinction between some signature types is partially
...
potential geographical bias. The details of the splitting method are available in the appendix \ref*{sec:appendixE}.
